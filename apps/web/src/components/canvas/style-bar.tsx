...
export function StyleBar() {
  ...
  return (
    <div
      className="flex max-w-[calc(100vw-4.5rem)] flex-wrap items-center justify-center gap-2 rounded-md border bg-background/90 px-2 py-1.5 shadow-md backdrop-blur"
      role="toolbar"
