...
| 11 | Editing & Organization | Rich text, sticky notes, layers panel, grouping, alignment, z-order, lock/rotate/resize, connectors, images/icons/emoji | `feat(web): editing tools + layers` | 🔄 In progress |
