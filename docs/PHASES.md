...
| - | ----- | ----- | -------------- | ------ |
| 1 | Foundation & Monorepo | Workspaces, git, gitignore, env contract, README, LICENSE, PRD, ADR log, phase tracker | `chore: init monorepo, git, docs` | 🔄 In progress |
| 2 | API Scaffold + Database | NestJS, Prisma, PostgreSQL, Redis, docker-compose, env validation, global pipes/filters/interceptors, health check, Swagger | `feat(api): nestjs scaffold + prisma + docker-compose` | ⬜ Pending |
